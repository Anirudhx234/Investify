...
export function InvestmentAdvice() {
  ...
  const ageAdvice = () => {
    ...
    if (age && age < 30) {
      ...
      return [
        ...
        <a href="https://www.investopedia.com/terms/e/etf.asp" className="link">
      ...
      return [
        ...
        <a
          href="https://www.schwab.com/learn/story/how-do-401ks-work-frequently-asked-questions"
          className="link"
        >
          More info about 401ks
        </a>,
      ];
    } else if (age && age >= 50) {
      indexOne = 2;
  ...
  const incomeAdvice = () => {
    ...
    if (income && income < 50000) {
    ...
    } else if (income && income >= 50000 && income < 100000) {
      indexTwo = 1;
      return [
      ...
      return [
        "Please enter your income to receive tailored investment advice.",
      ];
    }
  };
  ...
  const riskToleranceAdvice = () => {
    ...
    switch (riskTolerance) {
      ...
      default:
        return [
          "Please tell us your investment risk tolerance to receive tailored advice.",
        ];
    }
  };

  const tailoredAgeAdvice = ageAdvice();
  const tailoredIncomeAdvice = incomeAdvice();
  const tailoredRiskAdvice = riskToleranceAdvice();
  ...
  return (
    <div>
      ...
      {!clientProfileState.data?.investmentRisk && (
        <h1>
          Please tell us your investment risk tolerance under "Financial Goals".
        </h1>
      )}
